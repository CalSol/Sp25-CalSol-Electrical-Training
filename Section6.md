...
Now please follow the following links on making Gerber files and drill files (files that tell the manufacturer the design and layout of your board). We are using JCLPCB.

Now, go upload your design onto JCLPCB’s website to see if you have passed all their manufacturer constraints. 
